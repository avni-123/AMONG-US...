...
function preload(){
  ...
  enemy_moving = loadImage("alien2.png");
...
function draw(){
  ...
  if(gameState === PLAY){
    ...
    if(friendGroup.isTouching(black)){
...
function Enemies(){
  ...
  if(frameCount % 400 === 0){
    ...
    var enemy = createSprite(300, 100, 20, 20);
    
    enemy.y = Math.round(random(200, 300));
